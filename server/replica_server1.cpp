    ...
    try {
        ...
        for (;;) {
            ...
            if (command == "put") {
                ...
                std::cerr << "Invalid command received by replica 1\n";
            }
        }
    } catch (std::exception& e) {
        std::cerr << "Replica 1 connection error: " << e.what() << "\n";
    }
}
...
int main() {
    try {
        ...
        KeyValueStore store("C:/Users/Mohammad farmaan/OneDrive/Desktop/projects/db-cpp/db-cpp/db/replica1_db.txt");
        store.load_from_disk();

        std::cout << "Replica node  running on port 12346...\n";
        ...
        std::cerr << "Replica server error: " << e.what() << "\n";
    }
